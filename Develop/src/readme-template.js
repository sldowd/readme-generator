...
//license options:
//'GNU AGPLv3', 'GNU GPLv3', 'GNU LGPLv3', 'Mozilla Public License 2.0', 'Apache License 2.0', 'MIT', 'Boost Software', 'The Unlicense'
...
function renderLicenseSection(userInput) {
    if (userInput.license) {
        return `Copyright (c) ${userInput.githubUsername}. All rights reserved. 
...
${renderLicenseSection(userInput)}
